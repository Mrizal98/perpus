...
<head>
    <meta charset="UTF-8">
    <title>Perpus SDN 05 || Membaca menjadi lebih mudah!</title>
    ...
    <meta name="Perpus SDN 05" content="Perpus SDN 05" />
    <!-- bootstrap 3.0.2 -->
...
<body class="skin-black">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <b>Selamat Datang di Perpus SDN 05, Untuk Login silahkan klik Icon User atau klik <a href="login.html">disini</a></b> | Posted by <a href='https:Perpus SDN 05.com/' title='Perpus SDN 05.com' target='_blank'>Muhamad Rizal</a>
                                ...
                                <div class="twt-area">
                                    <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-pengunjung.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea rows="4" name="saran" id="saran" class="form-control" placeholder="Saran Anda untuk Perpus SDN 05" cols="25"></textarea>
                                                <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                                            </div>
                                        </div>
                                        <div class="form-group">
    ...
    <div class="footer-main">
        Copyright Perpus SDN 05 | Postedt by <a href='Muhamad Rizal' title='Perpus SDN 06' target='_blank'>Perpus SDN 05</a>
    </div>
    </aside><!-- /.right-side -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Perpus SDN 05</h4>
                </div>
                <div class="modal-body">
                    <p> Perpus SDN 05 adalah salah satu layanan bagi pengguna untuk dapat mengakses berbagai buku bacaan yang dan dilakukan kapan saja dan dari mana saja, dengan menggunakan jaringan internet.</p>
                    <p> Perpus SDN 05 memiliki koleksi buku dalam bentuk format digital dan bisa diakses dengan komputer. koleksi bacaan dari Perpus SDN 05 dapat diakses dengan cepat dan mudah lewat jaringan komputer.</p>
                    <p> Perpus SDN 05 bebasis website yang responsif, untuk info, saran, maupun kritik bisa menghubungi kami :</p>
                    <table>
                        <tr>
                            <td>E-mail</td>
                            <td>:</td>
                            <td><a href="zkyy1998@gmail.com">zkyy1998@gmail.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Blog</td>
                            <td>:</td>
                            <td><a href="#" target="_blank">www.Perpus SDN 05.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Website</td>
